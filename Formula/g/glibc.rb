...
class Glibc < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Homebrew/homebrew-core/6650107511d2bdbce2daaf5012fef7688c7e584a/Patches/glibc/2.39-test-fixes.patch"
  ...
  def install
    ...
    mkdir "build" do
      ...
      if build.bottle?
        ...
        # Intel x86_64 times out running tst-malloc-too-large-malloc-hugetlb2
